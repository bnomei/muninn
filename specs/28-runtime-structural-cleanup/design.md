...
This spec is a cleanup pass, not a behavior change program. Its goal is to make the runtime easier to change after contextual profiles/voices land.
...
The profile/voice feature from spec 27 should feed naturally into `EffectiveUtteranceConfig`.
...
### 6. Preserve runtime behavior while changing internals
...
### Phase E: Rebuild runtime tests around the real coordinator
