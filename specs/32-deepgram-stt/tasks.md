...
- [ ] T001: Add Deepgram provider config, defaults, and credential precedence rules (owner: unassigned) (scope: src/config.rs,tests/) (depends: spec:29-local-first-transcription-foundations)
...
- [ ] T002: Implement the built-in Deepgram backend and transcript writeback path (owner: unassigned) (scope: src/,src/internal_tools.rs,tests/) (depends: T001)
...
- [ ] T003: Align Deepgram failures with route continuation and preferred-cloud routing expectations (owner: unassigned) (scope: src/main.rs,src/replay.rs,src/,tests/) (depends: T002)
...
- [ ] T004: Document Deepgram’s role in the default ordered provider route (owner: unassigned) (scope: README.md,specs/32-deepgram-stt/) (depends: T002,T003)
